            ...
            <div className="library-hero-card">
                ...
                {/*    Left Part    */}
                    <div className="library-hero-text">
                        ...
                        <p className="library-hero-description">
                            Convert your books into interactive AI conversations. <br className="hidden md:block" /> Listen, learn and discuss your favourite reads.
                        </p>
                ...
                {/*    Centre Part    */}
                    <div className="library-hero-illustration-desktop">
                        <Image src="/assets/hero-illustration.png" alt="Vintage books" width={400} height={400} className="object-contain" />
                    </div>

                {/*    Centre Part - Mobile     */}
                    <div className="library-hero-illustration">
                        <Image src="/assets/hero-illustration.png" alt="Vintage books" width={300} height={300} className="object-contain" />
                    </div>
